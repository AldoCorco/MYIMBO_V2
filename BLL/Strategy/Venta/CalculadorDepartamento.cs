...
{
    /// <summary>
    /// Clase concreta que implementa la interfaz <see cref="ICalculadorVenta"/> para el cálculo específico de propiedades tipo departamento.
    /// </summary>
    public class CalculadorDepartamento : ICalculadorVenta
    {
        /// <summary>
        /// Calcula el total del boleto de venta para una propiedad tipo departamento.
        /// </summary>
        ...
        /// <summary>
        /// Calcula el valor total de dinero asociado a la venta de una propiedad tipo departamento, incluyendo comisiones e impuestos.
        /// </summary>
        /// <param name="valorPropiedad">El valor de la propiedad sobre la cual se realiza el cálculo.</param>
        /// <returns>El valor total de dinero asociado a la venta de la propiedad tipo departamento.</returns>
        ...
        /// <summary>
        /// Calcula el total del impuesto asociado a la venta de una propiedad tipo departamento.
        /// </summary>
        /// <param name="valorPropiedad">El valor de la propiedad sobre la cual se realiza el cálculo.</param>
