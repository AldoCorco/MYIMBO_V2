...
{
    /// <summary>
    /// Clase concreta que implementa la interfaz <see cref="ICalculadorVenta"/> para el cálculo específico de propiedades tipo casa.
    /// </summary>
    public class CalculadorCasa : ICalculadorVenta
    {
        /// <summary>
        /// Calcula el total del boleto de venta para una propiedad tipo casa.
        /// </summary>
        ...
        /// <summary>
        /// Calcula el valor total de dinero asociado a la venta de una propiedad tipo casa, incluyendo comisiones e impuestos.
        /// </summary>
        /// <param name="valorPropiedad">El valor de la propiedad sobre la cual se realiza el cálculo.</param>
        /// <returns>El valor total de dinero asociado a la venta de la propiedad tipo casa.</returns>
        ...
        /// <summary>
        /// Calcula el total del impuesto asociado a la venta de una propiedad tipo casa.
        /// </summary>
        /// <param name="valorPropiedad">El valor de la propiedad sobre la cual se realiza el cálculo.</param>
